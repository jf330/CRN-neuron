...
class NRM_live_test:
    ...
    def __init__(self, pre_syn, spec_mol, reactions, threshold, feature=[], dt=1000, mol_spike=100, live_file_path="/Users/jf330/Desktop", reporting=True, key_input=True, pattern_type="temporal"):
    ...
    def simulate(self, H_file_path, I_species, time_limit):
        ...
        if self.pattern_type != "temporal":
            self.pattern_event_q.append(["I0", 5000.0, 1])
